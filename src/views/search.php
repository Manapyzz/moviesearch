                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="duration" class="form-control" id="titleInput">
                            ...
                            <option value="2">Moins d'une heure</option>
                            <option value="3">Entre 1h et 1h30</option>
                            <option value="4">Entre 1h30 et 2h30</option>
                            <option value="5">Plus de 2h30</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
